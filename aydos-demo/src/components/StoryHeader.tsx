...
import { ChevronLeft, SlidersHorizontal, Bookmark, Layers, Image as ImageIcon, FolderOpen } from "lucide-react";
    ...
    >
      ...
      <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          {/* Media & Asset Hub button */}
          {onOpenAssetManager && (
            <button
              id="header-assets-btn"
              ...
              title="Manage Chapter Images & Audio"
            >
